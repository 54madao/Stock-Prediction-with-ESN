function [bestResult,telapsed,bestError,bestPredictedOutput] = main_scr(parNumber,nInputUnits,nInternalUnits,nOutputUnits,rType,goal,traininputSeq,testinputSeq,trainoutputSeq,testoutputSeq,dataMax,dataMin)
